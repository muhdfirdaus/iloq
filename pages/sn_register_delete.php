...
if($pswrd==$dbpswrd){
    $tmstmp = time();
    mysqli_query($con,"INSERT INTO sn_register_deleted(pwbsn,locksn,timestamp,del_timestamp)VALUES('$coresn','$padlocksn','$tmstmp_ori','$tmstmp')")or die(mysqli_error($con));
    mysqli_query($con,"DELETE from sn_register where pwbsn='$coresn'")or die(mysqli_error($con));
