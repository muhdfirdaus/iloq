            ...
            <h1>
             <a class = "btn btn-primary btn-print" href = "home.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a>   
               <a class = "btn btn-success btn-print" href = "" onclick="PrintDoc()"><i class ="glyphicon glyphicon-print"></i> Print</a>
			    <a class = "btn btn-primary btn-print" href = "export_accreditation.php"><i class ="glyphicon glyphicon-export"></i>Export to Excel</a>  
            </h1>
            <ol class="breadcrumb">
...
<?php
		...
		$query=mysqli_query($con,"select * from product  where branch_id='$branch' and validation='Accreditation' order by creation_date")or die(mysqli_error());
