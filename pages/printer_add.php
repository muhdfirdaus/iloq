            ...
            <div class="container">
                ...
                <section class="content">
                    <div class="panel panel-default">
                        <div class="panel-heading"><b>Printer Add</b></div>
                        <div class="panel-body">

                        <form id="form_model_edit" class="form-horizontal" method="post" action="printer_add_in.php" enctype='multipart/form-data'>
                        <table class="table table-bordered table-striped" width="50%">
                            ...
                            <tr>
                                <td><input required class="form-control" type="text" id="name" name="name" value=""></td>
                                <td><input required class="form-control" type="text" id="ip" name="ip" value=""></td>
                            </tr>
