              ...
              <div class="col-lg-12">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">Box Details</h3>
                  </div><!-- /.box-header -->
                  <div class="box-body">
                    <div class="row">
                      <!-- <div class="form-group">
                        <label class="control-label col-lg-2" for="equip_no">Serial No.</label>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                      <div class="col-lg-11">
                      <p>Product: <b>OVAL LOCK OUTDOOR C10S</b></p>
                      <p>Model Number: <b>IQ-M004142</b></p>
                      <p>Quantity: <b>20</b></p>
                      <p>Box ID: <b>B180904-IQ-M004142</b></p><br>
                        <table class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <?php for ($i=1; $i<=20; $i++) {
                                ...
                                <td class="text-center"><input class="form-control text-center" max="100" name="sn'.$i.'" id="sn'.$i.'" </td>';
                            }
                            ?>
                          </tbody>
                        </table>
